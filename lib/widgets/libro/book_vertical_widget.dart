...
class BookVertical extends StatelessWidget {
            ...
            children: [
              Hero(
                ...
                child: Stack(
                  children: [
                    _image(),
                    if (actualCollection != null && isFromCollection) _collection(actualCollection),
                  ],
                ),
              ),
              _info(colorCategoria, icon, currentRoute, context, categoria, leyendo),
            ],
          ),
        ),
      ),
  ...
  Widget _info(Color colorCategoria, IconData icon, String? currentRoute, BuildContext context,
      Categoria categoria, Leyendo? leyendo) {
    return Positioned(
      bottom: 0,
      left: 0,
      right: 0,
  ...
  Positioned _collection(CollectionBook actualCollection) {
    return Positioned(
      top: 0,
      left: 0,
      child: Container(
