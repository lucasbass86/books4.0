...
class CategoriaPage extends StatefulWidget {
  static const String routeName = 'CategoriaPage';
    ...
    if (!_isSearching) {
      switch (typeFilter) {
        ...
        case ETypeFilter.pendiente:
          libros = categoria.libros.where((l) => l.leido == 'NO').toList();
          break;
        case ETypeFilter.leyendo:
          libros =
              categoria.libros.where((l) => l.leido == 'NO' && l.fechInicio.isNotEmpty).toList();
          break;
      }
    }
    switch (eType) {
                      ...
                      itemBuilder: (BuildContext context) {
                        return [
                          if (leidos != libros.length)
                            PopupMenuItem(
                              onTap: () {
                                shuffleBook(context: context, categoria: categoria.name);
                              },
                ...
                LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    return ProgressBarWidget(
                      ...
                      backgroundColor: Utils.getCategoryColor(categoria.name).withAlpha(110),
