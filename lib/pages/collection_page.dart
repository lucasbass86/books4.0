...
class _CollectionPageState extends State<CollectionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    List<CollectionBook> booksOfCollection = servicio.collectionsBooks
      ...
      body: GestureDetector(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            ...
            if (collection.observaciones.isNotEmpty) _observaciones(collection),
            ListaLibrosSliverWidget(libros: filter, isFromCollection: true),
          ],
        ),
      ),
    );
  ...
  Widget _observaciones(Collection collection) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(collection.observaciones, style: Utils.mainTextStyle.copyWith(fontSize: 18)),
              ],
            ),
          ),
        ),
                ...
                Row(
                  ...
                  children: [
                    CircleAvatar(
                        ...
                        child: Text(collection.descripcion.substring(0, 1))),
                    Expanded(
                      child: Text(
                      ...
                      itemBuilder: (BuildContext context) {
                        return [
                          PopupMenuItem(
                            onTap: () {
                              double price =
                                  filter.fold(0, (previousValue, l) => previousValue + l.precio);
                              showMessage(
                                  context: context,
                                  message:
